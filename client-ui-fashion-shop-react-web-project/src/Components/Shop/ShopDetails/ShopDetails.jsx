...
const ShopDetails = () => {
  ...
  }, [page, selectedCategory, selectedPriceRange, searchTerm, sortOrder, dispatch]);
          ...
          <div className="shopDetails__right">
            <div className="shopDetailsSorting">
              ...
              <div className="shopDetailsSort">
                <select name="sort" id="sort" value={sortOrder} onChange={handleSortChange}>
                  <option value="default">Sắp xếp mặc định</option>
                  <option value="bestSelling">Bán chạy nhất</option>
                  <option value="a-z">Theo thứ tự chữ cái, A-Z</option>
                  <option value="z-a">Theo thứ tự chữ cái, Z-A</option>
